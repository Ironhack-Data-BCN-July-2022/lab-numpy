...
c = b.transpose(1,2,0)
#yes you can if you transpose them to the same shape
...
print (a)
print (d)
# d is floats where as a is integers
...
e == a
# c is all ones so it is equal if you multiply one by a value you get the same value
